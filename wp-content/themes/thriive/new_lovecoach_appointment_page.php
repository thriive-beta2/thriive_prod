<?php /* Template Name: New Lovecoach Appointment page */ 
...
if(have_rows('therapist_data', 'option')):
	while(have_rows('therapist_data', 'option')): the_row();
		if('love-therapy' ==  get_sub_field('taxonomy')->slug){
...
<div class="love-therapy-banner">
	<div class="sex-therapy-banner-con">
		<p class="line-01"></p>
		<!--<p class="line-02"> <img src="wp-content/themes/thriive/horoscope_new/sex-therapy-assets/assets/images/lv01-04.svg" alt=""></p>-->
	</div>
</div>
	...
	<div class="banner-home">
		<div class="container">			
			...
			<div id="therapyres">	
				...
				if($getPost) : ?>
					<h1 class="och1title">Premium Love Coach Readers</h1>
					...
					<section class="topreadingList">
						...
						foreach ( $getPost as $posts ) {
							...
							set_query_var('therapy',array('love-therapy'));
