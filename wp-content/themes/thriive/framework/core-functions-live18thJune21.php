...
*/
				...
				sendEmail('prathamesh@thriive.in',$current_user->user_email.' stage 1 completed', $current_user->user_email.' has submitted personal details information.');
				
				sendEmail('accountmanager2@thriive.in',$current_user->user_email.' stage 1 completed', $current_user->user_email.' has submitted personal details information.');
	...
	if(isset($input['total_therapies']) && isset($input['package']) && isset($input['communication'])){
			if(is_user_logged_in()){
				...
				if(isset($input['is_review_b4_publish'])){
					...
					sendEmail('prathamesh@thriive.in',$current_user->user_email.' stage 2 completed', $current_user->user_email.' has filled all required fields and submitted package details information.');
					sendEmail('accountmanager2@thriive.in',$current_user->user_email.' stage 2 completed', $current_user->user_email.' has filled all required fields and submitted package details information.');
				} else {
					sendEmail('prathamesh@thriive.in',$current_user->user_email.' stage 2 completed', $current_user->user_email.' has submitted package details information.');
					sendEmail('accountmanager2@thriive.in',$current_user->user_email.' stage 2 completed', $current_user->user_email.' has submitted package details information.');
...
function saveSocialNetworkDetails($input){
		if(is_user_logged_in()){	
				...
				sendEmail('prathamesh@thriive.in',$current_user->user_email.' stage 3 completed', $current_user->user_email.' has submitted socail network details information.');
				sendEmail('accountmanager2@thriive.in',$current_user->user_email.' stage 3 completed', $current_user->user_email.' has submitted socail network details information.');
