...
<div class="row">
    ...
    <div class="col-sm-6 col-xs-12 mx-sm-auto p-0 text-center" id="reg_hide">
        ...
        <div class="" style="padding:0px 5px">
            <form data-parsley-validate id="oc_call_seeker_signup_btn" class="form-element-section w-100" action="" method="post">
                ...
                <button type="submit" class="btn btn-primary" name="call_seeker_signup_btn" id="oc_call_seeker_signup_btn">Get Started</button>
            </form>
        ...
        <!-- <p class="w-100 disclamer footer_login">Already have an account? <span id="openloginform" style="cursor: pointer; color: #0362c7;">Log In</span></p> -->
    </div>
    <div class="col-sm-6 col-xs-12 mx-sm-auto p-0 text-center" id="reg_unhide" style="display: none;">
        <form data-parsley-validate class="form-element-section w-100" action="" method="post">
            ...
            <button class="login_btn" type="submit" name="verify_mobile" id="verify_mobile_oc" style="font-family: Roboto; margin-top: 10px;">Submit</button>
