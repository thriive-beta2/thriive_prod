<?php /* Template Name: New Angel card online consultation page */ 
...
<section class="banner">
        <img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2021/01/Soul-Listing-Page_Angel-Card-Reader-Mobile.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2021/01/Soul-Listing-Page_Angel-Card-Reader-Desktop.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
    </section>
			...
			if($getPost) : ?>
				<section class="topreadingList">
                    ...
                    foreach($tempArr as $t){
                        $post = get_post($t);
                        setup_postdata( $post );
                        set_query_var('therapy',array('angel-reading'));
