...
<div class="container">
	<div class="row">
	<h1 class="hpctitle" style="margin-bottom: -18px;margin-top: -20px;">Tarot Card Reading Online</h1>
		...
		<div class="container">			
			...
			if($getPost) : ?>
				<section class="topreadingList" >
					...
					$tempArr = array_merge($available,$mavailable);
					 
					//$tempArr = array_merge($mavailable,$tempArr);
