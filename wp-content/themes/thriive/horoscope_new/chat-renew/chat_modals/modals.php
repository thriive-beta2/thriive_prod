...
<?php if(1==1){ if( is_page(74075) || is_page(78002) || is_page(77203) || is_page(59025) || is_page(71622) || is_page(71271) || is_page(71345) || is_page(82834) /*|| is_page(548)*/){
    ...
    if($curr_ocid == ''){
      $curr_session_type = 'call';
      $curr_session_type = 'tarot-card-reading';
      $curr_ocid = '0';
    
?>
<script>
  OC_ID = <?php echo $curr_ocid;?>;
  ChangeDialogue(9);
...
//echo $curr_session_type;

  if($curr_session_type == 'chat'){
  ?>
<script src="<?php echo get_site_url();?>/wp-content/themes/thriive/horoscope_new/chat-renew/scripts/chat-script.js?v=20220609.43"></script>
...
include "/var/www/html/wp-content/themes/thriive/horoscope_new/instant_video/video-modals/video-modals.php";
  ...
  if($current_user->caps['therapist']==1){
    echo "<script>globalThis.OC_ID=12;ChangeDialogue(15);</script>";
  }else{
    echo "<script>globalThis.OC_ID=12;ChangeDialogue(9);</script>";
  }
    ...
    //print_r($previous_session);
      if($previous_session == '-1' || $previous_session == '-2'){
          ...
          echo '<script>document.querySelector("#session_data").innerText = "No Active Chat Sessions";
            //change_session_detail_lightbox_message("No ongoingwew sessions");
          </script>';
      } 
}
...
<script src="<?php echo get_site_url();?>/wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/scripts/chat-script.js?v=20220614.11"></script>
