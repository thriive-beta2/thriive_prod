<?php /* Template Name: Payment page plan 3 */ 
...
<div class="container">
	...
	<?php  
	   if($_GET['t'] == 'tarot-card-reading' || $_GET['t'] == 'angel-reading' || $_GET['t'] == 'vastu-shastra' || $_GET['t'] == 'cosmic-astrology' || $_GET['t'] == 'numerology' || $_GET['t'] == 'sex-therapist' || $_GET['t'] == 'counseling-consulting' || $_GET['t'] == 'meditation'){
		?>
		...
		<div class="col-md-12 col-xs-12">
			...
			if( have_rows('package_details','option') ):
				...
				while ( have_rows('package_details','option') ) : the_row();
					...
					$sessiondata = $wpdb->get_row("SELECT COALESCE(sum(remaining_session), 0) as remaining_session  FROM online_consultation WHERE uid = '". $current_user->ID ."' AND therapy_name = '".$_GET['t']."' AND pkgdescription LIKE '%".$pkgname."%' AND payment_status='success' AND remaining_session > 0");
					$m++;
					if($sessiondata->remaining_session == 0){ ?>
