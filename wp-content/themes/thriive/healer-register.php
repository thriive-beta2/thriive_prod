			...
			if(!empty($userPost->therapy)){
				for($i=0; $i<$userPost->therapy; $i++){
					...
					if(empty($userPost->$vtname) || empty($userPost->$viname) || empty($userPost->$vename) || empty($userPost->$vcname)){				 
						...
						update_user_meta($current_user->ID, 'is_review_b4_publish', 1);
					}
				}
			}
		}
...
<section class="package-selection-section" id="form-step-2">
	<div class="container">
		...
		<div class="row text-center section w-70">
			...
			<?php if($current_user->is_review_b4_publish == '1'){ ?>
				<p id="is_review_b4_publish" style="font-size: 14px; color: red;">Please filled all required fields</p>
			<?php } ?>
		</div>
		<?php }?>
							...
							<div class="add_therapy_section ">
								...
								<div class="form-group issue">
					 	  		...
					 	  		<div class="form-group exp">
						 	  		...
						 	  		?>
									<label for="experience">Experience (Practice since)<?php echo ($x == 0)?'*':''?></label><br/>
									<span style="font-size: 14px; font-weight: bold;">*Select Year , Month and Date</span>
			  		...
			  		<div class="form-group">
			  			<div class="row">
					  		...
					  		<div class="checkbox-wrapper col-6">
						  		<input type="checkbox" name="communication[]" value="Centre" id="centre" data-parsley-multiple="communication" data-parsley-errors-container="#message-holder" required <?php if(in_array("Centre" , $userPost->communication_mode)){ echo "checked"; } ?>>
						  		<label for="centre">Centre</label>
					  		</div>
					  		
					  		<div class="checkbox-wrapper col-6">
						  		<input type="checkbox" name="communication[]" value="Via Skype" id="skype" data-parsley-multiple="communication" data-parsley-errors-container="#message-holder" required <?php if(in_array("Via Skype" , $userPost->communication_mode)){ echo "checked"; } ?>>
						  		<label for="skype">Via Skype</label>
					  		</div>
					  		
					  		<div class="checkbox-wrapper col-6">
						  		<input type="checkbox" value="Long Distance" name="communication[]" id="long-distance" data-parsley-multiple="communication" data-parsley-errors-container="#message-holder" required <?php if(in_array("Long Distance" , $userPost->communication_mode)){ echo "checked"; } ?>>
						  		<label for="long-distance">Long Distance</label>
					  		</div>
					  		
					  		<div class="checkbox-wrapper col-6">
						  		<input type="checkbox" value="Overphone" name="communication[]" id="overphone" data-parsley-multiple="communication" data-parsley-errors-container="#message-holder" required <?php if(in_array("Overphone" , $userPost->communication_mode)){ echo "checked"; } ?>>
						  		<label for="overphone">Overphone</label>
					  		</div>
					  		
					  		<div class="checkbox-wrapper col-6">
						  		<input type="checkbox" value="Home Visit" name="communication[]" id="at-home" data-parsley-multiple="communication" data-parsley-errors-container="#message-holder" required <?php if(in_array("Home Visit" , $userPost->communication_mode)){ echo "checked"; } ?>>
						  		<label for="at-home">Home Visit</label>
					  		</div>
					  		
					  		<div class="checkbox-wrapper col-6">
						  		<input type="checkbox" value="Online" name="communication[]" id="online" <?php if(in_array("Online" , $userPost->communication_mode)){ echo "checked"; } ?>>
		...
		<div class="row section i_w_p col-12 mx-auto">
			<form data-parsley-validate  class="form-element-section" id="verification_details" name="verification_details" action="<?php if(isset($_GET['edit-step'])){ echo get_permalink(339); } ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="<?php if(isset($_GET['edit-step'])){ echo "hidden"; }else{ echo "text"; } ?>" placeholder="Add your 1st reference name" class="form-control" id="reference-name-1" name="reference_name_1" value="<?php echo $userPost->first_reference_name;?>" data-parsley-required-message="1st Reference Name is required." required>
				</div>
				
				<div class="form-group">
				 	<label for="ref-email-1" class="<?php if(isset($_GET['edit-step'])){ echo "d-none"; } ?>">Email</label>
				 	<input data-parsley-type="email" type="<?php if(isset($_GET['edit-step'])){ echo "hidden"; }else{ echo "email"; } ?>" class="form-control" id="ref-email-1" name="ref_email_1" placeholder="Add your 1st reference email ID" value="<?php echo $userPost->first_reference_email;?>" data-parsley-required-message="1st Reference Email is required." required>
			  </div>
			  
			  <div class="form-group">
			    	<label for="reference-name-2" class="<?php if(isset($_GET['edit-step'])){ echo "d-none"; } ?>">2nd Reference Name</label>
					<input type="<?php if(isset($_GET['edit-step'])){ echo "hidden"; }else{ echo "text"; } ?>" placeholder="Add your 2nd reference name" class="form-control" id="reference-name-2" name="reference_name_2" value="<?php echo $userPost->second_reference_name;?>"data-parsley-required-message="2nd Reference Name is required." required>
				</div>
				
				<div class="form-group">
				 	<label for="ref-email-2" class="<?php if(isset($_GET['edit-step'])){ echo "d-none"; } ?>">Email</label>
				 	<input data-parsley-type="email" type="<?php if(isset($_GET['edit-step'])){ echo "hidden"; }else{ echo "email"; } ?>" class="form-control" id="ref-email-2" name="ref_email_2" placeholder="Add your 2nd reference email ID" value="<?php echo $userPost->second_reference_email;?>" data-parsley-required-message="2nd Reference Email is required." required>
			  </div>
			  
			  <div class="form-group">
			    	<label for="reference-name-3" class="<?php if(isset($_GET['edit-step'])){ echo "d-none"; } ?>">3rd Reference Name</label>
					<input type="<?php if(isset($_GET['edit-step'])){ echo "hidden"; }else{ echo "text"; } ?>" placeholder="Add your 3rd reference name" class="form-control" id="reference-name-3" name="reference_name_3" value="<?php echo $userPost->third_reference_name;?>" data-parsley-required-message="3rd Reference Name is required." required>
				</div>
				
				<div class="form-group">
				 	<label for="ref-email-3" class="<?php if(isset($_GET['edit-step'])){ echo "d-none"; } ?>">Email</label>
				 	<input data-parsley-type="email" type="<?php if(isset($_GET['edit-step'])){ echo "hidden"; }else{ echo "email"; } ?>" class="form-control" id="ref-email-3" name="ref_email_3" placeholder="Add your 3rd reference email ID" value="<?php echo $userPost->third_reference_email;?>" data-parsley-required-message="3rd Reference Email is required." required>
			  </div>
...
-->
			  ...
			  <div class="form-group d-flex flex-wrap">
			   ...
			   <div class="form-group d-flex flex-wrap">
					  ...
					  <div class="row">
						  <div class="col-8 text-left">
							  <label class="" for="profile-picture">Gallery</label>
							  <span class="d-block label_img_msg">( *Multiple gallery image can be added ) </span>
						  </div>
						  <div class="col-12 pl-0" id="gallery_verify"></div>
					  </div>
				  	</div>
				  	<div class="col-12 p-0">
					  <div class="imagePreview1" style="<?php if(!empty($userPost->gallery)){echo 'display: inline-block;'; };?>">
					  	   <i class="fa fa-spinner"></i>
						   <?php 
						   $totalimages = 0;
							   //echo "<pre>";print_r($userPost->gallery);echo"</pre>";
							   for ($x = 0; $x < $userPost->gallery; $x++) { 
									$imageIdKey = 'gallery_'.$x.'_images';
									$imgId = get_post_meta($current_user->post_id,$imageIdKey,true);
					...
					?>
				  	<div class="col-12 p-0 mt-2">
					    ...
					    <span class="fileinput-button">
					        ...
					        <span class="btn btn-upload">Select Files</span>
					        <!-- The file input field used as target for the file upload widget -->
					        <input id="gallery" type="file" data-currentimage="<?php echo $totalimages;?>" data-maximage="<?php echo $max_images;?>"  data-url="<?php echo get_template_directory_uri(); ?>/lib/file-upload/server/php/" data-name="images" name="files" accept="image/x-png,image/jpeg" multiple>
					    </span>
...
<!-- 				 	<label >Your account has been created successfully. <br>You will be informed via email/SMS once the account has been verified by Thriive Account Manager.</label> -->
  ...
  <div class="modal fade" id="account_in_rejected_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      <div class="modal-content">
      
        <!-- Modal body -->
        <div class="modal-body">
         <form data-parsley-validate class="form-element-section"  id="rejected_account">
	         <div class="row section col-sm-12 col-12 mx-auto p-0">
		        <div class="form-group col-12 text-center">
			       <label> Sorry</label>
				   <p>You profile is been rejected.</p>
				   <p>Please email to accountmanager1@thriive.in for further enquiry.</p>
					</div><a href="<?php echo  wp_logout_url('/'); ?>" class=" mx-auto btn btn-primary">  &nbsp;&nbsp;&nbsp; OK  &nbsp;&nbsp;&nbsp;  </a>
	         </div>	          
         </form>                  
        </div>
...
<?php 
	...
	}else if(get_post_status( $current_user->post_id )=='rejected') {
		echo '<script type="text/javascript">$("#account_in_rejected_modal").modal();</script>';
	}
?>