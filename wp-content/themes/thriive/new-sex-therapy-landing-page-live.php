<?php /* Template Name: New sex therapy landing page live */ 
	...
	<div class="banner-home">
		<div class="container">			
			...
			<div id="therapyres">	
				...
				if($getPost) : ?>
					<h1 class="och1title">Premium Sex Therapy Readers</h1>
					...
					<section class="topreadingList">
						...
						foreach ( $getPost as $posts ) {
							...
							get_template_part( 'template-parts/therapist-appointment-content-live');
