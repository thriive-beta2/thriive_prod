<?php /* Template Name: New plr appointment page */ 
...
<div class="container">
	<div class="row">
		<h1 class="hpctitle">Past Life Regression Therapy</h1>
		<p class="hpcdesc">Past Life Regression Therapy uses a deep, self-induced, relaxed hypnosis technique to tap into past life memories stored in the subconscious mind. Many mental, emotional, or false memories can stem from traumatic past life events. With PLR, you can tap into and heal several mental and emotional health issues, recover memories from a previous life and look at your current life experiences differently. "Relive to relieve."<p>
			...
			<div id="therapyres">	
				<?php if(have_rows('therapist_data', 'option')):
					while(have_rows('therapist_data', 'option')): the_row();
						if('plr-appointment-page' ==  get_sub_field('taxonomy')->slug){
