<?php /* Template Name: New Astrology online consultation page */ 

//redirecting this page to tarot page

header('location: https://www.thriive.in/talk-to-best-tarot-card-reader-online');
...
<div class="container">
    <div class="row">
    <h1 class="hpctitle" style="margin-bottom: 15px;margin-top: -20px;">Instant Online Astrology Reading</h1>
    </div>  
</div>  
			...
			if($getPost) : ?>
				<section class="topreadingList" >
                    ...
                    foreach($tempArr as $t){
                        $post = get_post($t);
                        setup_postdata( $post );
                        set_query_var('therapy',array('cosmic-astrology'));
