...
globalThis.disabled_calls = false;
...
window.addEventListener('resize', function(){
    if(window.screen.width < 875){
        if(window.screen.width > window.screen.height){
            document.querySelector('#block_landscape_chat').style.display = 'flex';
            console.log('landscape');
            //alert(window.screen.width);
        }else if(window.screen.width < window.screen.height){
            document.querySelector('#block_landscape_chat').style.display = 'none';
...
function book_another_session(dialogue){
    ...
    if(dialogue == 'first'){
    $.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment_test/Appointment/php/chat_functions.php', {action:'fetch_link',therapist:to}, function(data){
        ////console.log(data);
...
<img id="star1" onmouseover="star(1,'therapist');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
<img id="star1" onmouseover="star(2,'therapist');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
<img id="star1" onmouseover="star(3,'therapist');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
<img id="star1" onmouseover="star(4,'therapist');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
<img id="star1" onmouseover="star(5,'therapist');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
...
<img id="star2" onmouseover="star(1,'experience');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
<img id="star2" onmouseover="star(2,'experience');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
<img id="star2" onmouseover="star(3,'experience');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
<img id="star2" onmouseover="star(4,'experience');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
<img id="star2" onmouseover="star(5,'experience');" src="http://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/star2.png">
</div></section><section style="
        padding: 5px;
        border-radius: 5px;
        color: #fff;
...
function feed_star_rating(ocid = 0,therapist_rating,experience_rating){
  $.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php', {ocid:ocid,action:'feed_star_rating',therapist_rating:therapist_rating, experience_rating:experience_rating},function(data){
    ////console.log(data);
    if(data == 1){
...
function create_dialog(to, from, mail, msg) {
  ...
  document.querySelector(".main-messages").innerHTML = `
      ...
      <div class="msg">
        <div class="input_div">
        <button class="emoji_icon" id="emoji_icon" onClick="hide_emoji()"><img draggable="false" class="emoji" alt="😊" src="https://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/new_emoji_icon.png"></button>
        ...
        <button type="button" id="click_attatch" onclick="click_attatch()">
          <img src="https://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/new_attach_icon.png">
        </button>
      </div>
      <button type="button" id="send" onclick="write_to_file()">
        <img src="https://www.thriive.in/wp-content/themes/thriive/horoscope_new/chat-renew/base_img/new_send_icon.png" style="width: 35px;">
      </button>
      </div>
  ...
  $.post(
    "wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php",
  ...
  // $.post(
  //  'wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php?data=1 ',
...
//      console.log(chatHistory);
  ...
  if(window.location.href == 'https://www.thriive.in/appointment'){
    insert_new_chat_header();
  }
}
...
function alert_support(mode){
  $.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment_test/Appointment/php/GET_CURR_USER.php', {action:'alert_support', ocid:OC_ID, mode:mode}, function(data){
    //console.log(data);
  });
}
...
/*$.post("wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/GET_CURR_USER_test.php", {action:'delivery_stat', ocid:OC_ID}, function(data){
  alert(data);
})*/

}

function generateChatHistoryBubble(message, id){
  ...
  let response;
  if(message['seen'] == 0){
      chat_seen_stat(id, message['sender']);  
  }
  ...
  if(message['message'].split(',')[0] == 'hide'){
    ...
    if(new Date() < newDate){
            //response = generate_call_prompt_html(from);
            //return response;
      //console.log(newDate);
    ...
    response = `
      <div id='${id}' style='display:unset;'>
        <div class="${className}">
          A call was placed ${message['seen']}
          }
...
function generateChatBubble(message, id) {
  ...
  if(message['message'].split(',')[0] == 'hide'){
      ...
      if(message['message'].split(',')[1] == 'call'){
        if(new Date() < newDate){
          console.log(new Date(message['timestamp']));
          response = generate_call_prompt_html(message['sender'],id);
          setTimeout('disable_call_link('+id+')', 60000);
        }else{
          response = generate_call_prompt_html('expired', id);
        }        
      }else if(message['message'].split(',')[1] == 'video'){
        if(new Date() < newDate){
          console.log(new Date(message['timestamp']));
          response = generate_video_prompt_html(message['sender'],id);
          setTimeout('disable_video_link('+id+')', 60000);
        }else{
          response = generate_video_prompt_html('expired', id);
        } 
      }else if(message['message'].split(',')[1] == 'video_start'){
        if(new Date() < newDate){
          console.log(new Date(message['timestamp']));
          response = generate_video_prompt_html(message['sender'],id,'video_start');
          //the line below is called inside generate_video_prompt function to avoid overlap;
          //setTimeout('disable_video_link('+id+','+message['sender']+')', 60000);
        }else{
          response = generate_video_prompt_html('expired', id);
        } 
      }else{
      ...
      //insert_call_prompt(message['message'].split(',')[2]);
      //return response;
  }else if (message.img === undefined || message.img === "") {
    response = `
      <div id='${id}'>
        <div class="${className}">
          ${message.message}
...
function read() {
  ...
  //  var action = 'read';
  //  $.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php',
...
function check_all_chats() {
  ...
  $.post(
    "wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/GET_CURR_USER.php",
    ...
    function (data) {
      ...
      if (data) {
        ...
        if (ret_data[0] == "t0") {
        ...
        } else if (ret_data[0] == "t9") {
            ChangeDialogue(20,ret_data[8],ret_data[4],ret_data[9]);
        } else if (ret_data[0] == "t8") {
            ChangeDialogue(15,ret_data[8],ret_data[4],ret_data[9]);
        } else if (ret_data[0] == "t7") {
            ChangeDialogue(22,ret_data[8],ret_data[4],ret_data[9]);
        }
          ...
          ChangeDialogue(17,ret_data[8]);
          
        }else if(ret_data[0] == "u7"){
          ChangeDialogue(15,ret_data[8]);
          
        }else if(ret_data[0] == "u8"){
          ChangeDialogue(19,ret_data[8]);
...
if(created_time.length<4 && fetch_time_call == 0){
  if(fetch_time_call == 0){
    fetch_time_call = 1;
  $.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php',{action:'created_time',ocid:ocid},function(data){
...
if(sec==30 || sec==0 || sec==59 || sec==58){
  /*$.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php',{action:'set_time',curr_time:time_string,ocid:ocid},function(data){//console.log(data);
    if(data){
      //console.log(data);
    }
  });*/
...
function revive_therapist(ocid) {
  //$.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php',{action:'revive',ocid:ocid},function(data){//console.log(data)});
}
  ...
  $.post(
    ...
    function (data) {
      ...
      if (data) {
        ...
        window.location.replace('https://www.thriive.in/appointment');
      }
    }
  );
...
async function pushDataToSQL(data) {
  ...
  formData.append("ocid", OC_ID);
/*
  $.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php',{data:JSON.stringify(data),action:action,to:to,from:from,ocid:OC_ID},function(data){
    console.log(data);
  });*/
