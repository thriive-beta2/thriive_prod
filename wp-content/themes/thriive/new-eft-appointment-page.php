<?php /* Template Name: New eft appointment page */ 
...
<div class="container">
	<div class="row">
		<h1 class="hpctitle">Emotional Freedom Technique</h1>
		<p class="hpcdesc">Emotional Freedom Technique is a tapping, self-acupressure type technique that releases negative emotions stored in the body. Tapping main meridian points can restore an imbalanced energy pattern in the body. <p>
		
		<p class="counhead">EFT helps with:</p>
		<div class="col-md-6 col-xs-6">
		<p class="maillist">Anxiety & Stress</p>
		</div>
		<div class="col-md-6 col-xs-6">
		<p class="maillist">Anger Management</p>
		</div>
		<div class="col-md-6 col-xs-6">
		<p class="maillist">Career Issues</p>
		</div>
		<div class="col-md-6 col-xs-6">
		...
		<div class="col-md-6 col-xs-6">
		<p class="maillist">Lack of Clarity</p>
		</div>
		<div class="col-md-6 col-xs-6">
		<p class="maillist">Phobia</p>
		</div>
		<div class="col-md-6 col-xs-6">
		<p class="maillist">Addiction Issues</p>
		</div>
		<div class="col-md-6 col-xs-6">
			...
			<div id="therapyres">	
				<?php if(have_rows('therapist_data', 'option')):
					while(have_rows('therapist_data', 'option')): the_row();
						if('eft-appointment' ==  get_sub_field('taxonomy')->slug){
				...
				if($getPost) : ?>
					...
					<section class="topreadingList">
						...
						foreach($tempArr as $t){
							...
							set_query_var('therapy',array('eft-emotional-freedom-technique'));
