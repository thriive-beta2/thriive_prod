...
.inner_img{
  background-image: url("https://www.thriive.in/wp-content/uploads/2022/02/thriive-web-banner_480.jpg");
  width: 100%;
  height:100px;
      background-position: center;
    background-repeat: no-repeat;
...
<div class="container text-center" style="margin-top: -20px;margin-bottom: 10px;display: none;">
...
<p class="hometoptext" style="margin-bottom: -6px;"><span style="color:#2a2b5e; font-size:22px;text-align:center !important">Astro  Wellness</span></p>
...
<div class="dropdown">
  ...
  <div id="myDropdown" class="dropdown-content">
   <!-- <input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()">-->
	...
	<!--<a href="https://www.thriive.in/talk-to-best-astrology-online">Astrology</a>
	<!--<a href="https://www.thriive.in/talk-to-best-numerologist-online">Numerology</a>
	<a href="https://www.thriive.in/talk-to-best-angel-card-reader-online">Angel Card Reading</a>
	<a href="https://www.thriive.in/hypnotherapy1">Hypno Therapy</a>
...
<p class="hpledesc">Talk to India’s top verified Holistic  Wellness Experts. Thriive your way to spiritual balance.</p>
...
<!--<a href="" onclick="alert('Coming Soon');">-->
  <a href="https://www.thriive.in/sexual-wellness">
<p class="hpexptitle" style="font-size:14px !important;">Sexual Wellness Experts</p>
<img class="hpexpimag hpexpcimg"  src="https://www.thriive.in/wp-content/themes/thriive/assets/images/newsoulimg/counselor-Icons-02.svg" alt="Sexual Wellness Experts" title="Sexual Wellness Experts"/></a>
</div>
...
<a href="https://www.thriive.in/new-lovecoach-landing-page">
<p class="hpexptitle">Love & Relationship Coach</p>
<img class="hpexpimag hpexpsimg" src="https://www.thriive.in/wp-content/themes/thriive/assets/images/newsoulimg/sex-thrapy-Icons-03.svg" alt="Love & Relationship Coach" title="Love & Relationship Coach"></a>
</div>
    ...
    <section id="counselor_accordion_block" class="widgetblock">
      ...
      <section id="counselor_accordion" class="ew_accordion">
        ...
        <li class="">
            ...
            <a href="https://www.thriive.in/sexual-wellness" class="counsellink"></a>
        </li>
        <li class="">
            <div class="bgholder family-therapy">
...
<!--
        Astrology and numerology hidden
        
        <li class="sectionitem col-6 col-sm-3">
          <a href="http://www.thriive.in/talk-to-best-astrology-online">
            <figure>
              <img src="<?php echo get_template_directory_uri() .'/assets/images/newsoulimg/astro-card.png'; ?>" alt="Astrology" title="Astrology">
      ...
      <li class="sectionitem col-6 col-sm-3">
      <a href="http://www.thriive.in/talk-to-best-numerologist-online">
        <figure>
        <img src="<?php echo get_template_directory_uri() .'/assets/images/newsoulimg/numerology.png'; ?>" alt="Numerology" title="Numerology">
      ...
      <li class="sectionitem col-6 col-sm-3">
            <a href="https://www.thriive.in/sexual-wellness">
              <!--<a href="" onclick="alert('Coming Soon')"> -->
              <figure>
                <img src="https://beta1.thriive.in/wp-content/themes/thriive/assets/images/newsoulimg/sex-Icons-10.svg" alt="Tarot Card Reading" title="Tarot Card Reading">
                <figcaption>Sexual Wellness</figcaption>
              </figure>
            </a>
          </li>
	  ...
	  <!--<li class="sectionitem col-6 col-sm-3">
          <a href="http://www.thriive.in/talk-to-best-angel-card-reader-online">
            <figure>
              <img src="<?php echo get_template_directory_uri() .'/assets/images/newsoulimg/reading-angel.png'; ?>" alt="Angel Card Reading" title="Angel Card Reading">
