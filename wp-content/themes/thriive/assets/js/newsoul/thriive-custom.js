...
$(document).ready(function() {
    var e = int_number1 = "";
    if ($("#left-side-menu li.menu-item-has-children a").addClass("dropdown-toggle"), $("#left-side-menu li.menu-item-has-children a").attr("data-toggle", "dropdown"), $("#left-side-menu li.menu-item-has-children a").attr("role", "button"), $("#left-side-menu li.menu-item-has-children a").attr("aria-haspopup", "true"), $("#left-side-menu li.menu-item-has-children a").attr("aria-expanded", "false"), $("#left-side-menu li.menu-item-has-children ul").removeClass(), $("#left-side-menu li.menu-item-has-children ul").addClass("dropdown-menu").show(), $("#left-side-menu li.menu-item-has-children ul li a").removeClass(), $("#left-side-menu li.menu-item-has-children ul li a").addClass("dropdown-item"), $("a.dropdown-item").removeAttr("data-toggle"), $("a.dropdown-item").removeAttr("role"), $("a.dropdown-item").removeAttr("aria-haspopup"), $("a.dropdown-item").removeAttr("aria-expanded"), $(window).width() < 700 ? $(".user-loggedin a.link_profile").click(function(e) {
    ...
    if (jQuery(".international-number1").length > 0) {
	 ...
	 $(".covid_link_oc").unbind("click").click(function(e) {
        e.preventDefault();
    ...
    $(".consult_online_link_oc").unbind("click").click(function(e) {
        ...
        if (clevertap.event.push("Therapist Clicked", {
            ...
            event_category: "button",
            event_label: "call now clicked - desktop"
        }), $(".modal-body #reg_hide #lead_source").val(a), $(".modal-body #reg_unhide #slug").val(t), $(".modal-body #reg_unhide #action").val("call"), $(".modal-body #reg_unhide #cat").val(k), $(".modal-body #reg_unhide #therapy").val(a), $(".modal-body #reg_unhide #payment").val(1), $("#login_popup").modal("show"), !1;
        ...
        "tarot-card-reading" == a || "angel-reading" == a  || "cosmic-astrology" == a || "numerology" == a ? window.location.replace(window.location.protocol + "//" + window.location.host + "/new-payment-apage?q=" + t + "&a=call&t=" + a + r+"&c=" + k) : "meditation" == a ? window.location.replace(window.location.protocol + "//" + window.location.host + "/payment-page-plan-3?q=" + t + "&a=call&t=" + a + r+"&c=" + k) : window.location.replace(window.location.protocol + "//" + window.location.host + "/payment-details?q=" + t + "&a=call&t=" + a + r+"&c="+k)
        ...
        }), $(".modal-body #reg_hide #lead_source").val(n), 
		$(".modal-body #reg_unhide #slug").val(o), 
		$(".modal-body #reg_unhide #action").val("chat"), 
		$(".modal-body #reg_unhide #therapy").val(n), 
		$(".modal-body #reg_unhide #cat").val(k),
        ...
        l = s ? "&pt=" + s : "", "tarot-card-reading" == n || "angel-reading" == n || "cosmic-astrology" == n || "numerology" == n ? window.location.replace(window.location.protocol + "//" + window.location.host + "/new-payment-apage?q=" + o + "&a=chat&t=" + n + l+"&c=" + k) : window.location.replace(window.location.protocol + "//" + window.location.host + "/payment-details?q=" + o + "&a=chat&t=" + n + l+"&c="+k)
    }), 
$(".book_now_sex_link_oc").unbind('click').click(function(e){
		...
		//if(sessions > 0){
			window.location.replace(window.location.protocol + "//" + window.location.host + "/appointment-booking-page?q="+slug+"&t=Appointment&c="+therapy); 
		/* } else { 
			window.location.replace(window.location.protocol + "//" + window.location.host + "/therapy-payment-page?q="+slug+"&t=Appointment&c="+therapy); 
		} */		
		
	  });
        //Added By Akash 
        $(".start_video_oc").unbind("click").click(function(e) {
        var t = $("#chat_event").val(),
            a = $(this).data("from_status"),
            o = ($(this).data("to_status"), $(this).data("touserid"), $(this).attr("data-role"), $(this).data("tousername"), $(this).data("fromuserid"), $(this).data("slug")),
            n = $(this).data("therapy"),
        ...
        if (clevertap.event.push("Therapist Clicked", {
            ...
            event_category: "button",
            event_label: "online - chat now clicked - " + t
        }), $(".modal-body #reg_hide #lead_source").val(n), $(".modal-body #reg_unhide #slug").val(o), $(".modal-body #reg_unhide #action").val("videocall"), $(".modal-body #reg_unhide #therapy").val(n), $(".modal-body #reg_unhide #payment").val(1), $("#call_with_healer").modal("show"), !1;
        if (1 == a && 1 == i) return $("#" + r).modal("show"), !1;
        0 != a && gtag("event", "click", {
            event_category: "button",
            event_label: "online - chat now initiated - " + t
        ...
        var l, s = $(".payment_type").val();
        l = s ? "&pt=" + s : "", "tarot-card-reading" == n || "angel-reading" == n || "aura-reading" == n  || "vastu-shastra" == n || "cosmic-astrology" == n || "numerology" == n ? window.location.replace(window.location.protocol + "//" + window.location.host + "/new-payment-apage?q=" + o + "&a=videocall&t=" + n + l) : "meditation" == n ? window.location.replace(window.location.protocol + "//" + window.location.host + "/payment-page-plan-3?q=" + o + "&a=videocall&t=" + n + l) : window.location.replace(window.location.protocol + "//" + window.location.host + "/payment-details?q=" + o + "&a=videocall&t=" + n + l)
    })
        //ENDS HERE
    ...
    , $(".cbook_now_link_oc").unbind("click").click(function(e) {
        ...
        if (clevertap.event.push("Therapist Clicked", {
            ...
            event_category: "button",
            event_label: "online - book later clicked - mobile"
        }), $(".modal-body #reg_hide #lead_source").val(a), $(".modal-body #reg_unhide #slug").val(t), $(".modal-body #reg_unhide #action").val("book_later"), $(".modal-body #reg_unhide #therapy").val(a), $(".modal-body #reg_unhide #payment").val(1), $("#login_popup").modal("show"), !1;
        ...
        var n, i = $(this).attr("id").split("_"),
            ...
            s = $(".payment_type").val();
        if (n = s ? "&pt=" + s : "", "" == r || "" == l) return alert("Please try again later!"), !1;
        window.location.replace(window.location.protocol + "//" + window.location.host + "/booking-date-and-time?q=" + t + "&a=appointment_chat&t=" + a + n)
        ...
        if (t.preventDefault(), t.stopPropagation(), $(this).parsley().validate()) {
            ...
            var n = $("#email-id").val(),
				...
				f = $("#fname").val();
			/* if(f.indexOf(' ') >= 0){
				return $("#error_msg").html("Contains spaces at the end in firstname")
			} */
			if (emailReg.test(f)) return $("#error_msg").html("Email ID Not Allowed in first Name"), !1;	
            $.ajax({
                url: myajax.ajax_url, 
                type: "POST", 
                data: {
                ...
                success: function(e) {
                    try {
                        var t = JSON.parse(e);
                        if ("error" == t.resStatus) $("#error_msg").text(t.resMessage);
                ...
                success: function(e) {
                    ...
                    try {
                        ...
                        "error" == n.resStatus ? ($("#error_msg_otp").text(n.resMessage), clevertap.event.push("Signup", {
                            ...
                            event_category: "button",
                            event_label: a
                        }), $("#error_msg_otp").text(""), $("#error_msg_otp").text(n.resMessage), 1 == o && ("video_call" == r || "book_later" == r) ? 1 == o && ( "video_call" != r || "book_later" != r) ? location.reload(!0) : window.location.replace(window.location.protocol + "//" + window.location.host + "/booking-date-and-time?q=" + i + "&a=" + r + "&t=" + l + t) : "tarot-card-reading" == l || "angel-reading" == l || "aura-reading" == l  || "vastu-shastra" == l || "cosmic-astrology" == l || "numerology" == l ? window.location.replace(window.location.protocol + "//" + window.location.host + "/new-payment-apage?q=" + i + "&a=" + r + "&t=" + l + t+"&c=" + k) : location.reload(!0)) : $("#error_msg_otp").text(n.resMessage), clevertap.event.push("Signup", {
                            "Page Source": window.location.href,
                            Method: "Email & Mobile Number",
                            Status: "Success"
                        }))
        ...
        o ? $.ajax({
            ...
            success: function(o) {
                var n = JSON.parse(o);
				$('.selected_coupon_code').val(o); 
				if("success" == n.resStatus && ("tarot-card-reading" == a || "angel-reading" == a || "cosmic-astrology" == a || "numerology" == a)){
					window.location.replace(window.location.protocol + "//" + window.location.host + "/new-coupon-payment-apage?q=" + e + "&a=" + t + "&t=" + a+"&code="+n.code+ "&c=" + k);
				} else if("error" == n.resStatus) {
					$("#coupon_msg").text(n.resMessage);
				}
					
               /*  "error" == n.resStatus && $("#coupon_msg").text(n.resMessage), "success" == n.resStatus && ("tarot-card-reading" == a || "angel-reading" == a || "aura-reading" == a || "vastu-shastra" == a || "cosmic-astrology" == a || "numerology" == a ? window.location.replace(window.location.protocol + "//" + window.location.host + "/new-coupon-payment-apage?q=" + e + "&a=" + t + "&t=" + a+"&code="+n.code+ "&c=" + k) : window.location.replace(window.location.protocol + "//" + window.location.host + "/coupon-payment-page?q=" + e + "&a=" + t + "&t=" + a+ "&c=" + k)) */
            },
            complete: function(e) {
...
function whatsapp_payment_reminder(q,t,c,uid){
	//alert(myajax.ajax_url);
	 $.ajax({
		...
		data: {
			action: "whatsapp_payment_reminder",
			therapist: q,
			therapy_name: t,
			category_name: c,
			uid: uid,
