<?php /* Template Name: New hyphonotherapist appointment page */ 
...
<!--<div class="container">			
			<div class="row">
				<div class="seprator hypnoc" style="margin-top: -40px !important">
					<img style="" src="<?php //	echo get_template_directory_uri() .'/assets/images/newsoulimg/Thriive-Hypnotherapy-aapoinment.svg'; ?>" alt="">
				</div>
			</div>
</div>-->
<header class="">
			...
			<div id="therapyres">	
				<?php if(have_rows('therapist_data', 'option')):
					while(have_rows('therapist_data', 'option')): the_row();
						if('hypnotherapy-appointment-page' ==  get_sub_field('taxonomy')->slug){
				...
				if($getPost) : ?>
					...
					<section class="topreadingList">
						...
						foreach($tempArr as $t){
							...
							set_query_var('therapy',array('hypno-therapy'));
