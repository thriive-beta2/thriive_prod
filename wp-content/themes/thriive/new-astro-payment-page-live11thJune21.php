...
<div class="container">
		...
		<?php 	
	$sessiondata = $wpdb->get_row("SELECT remaining_session,session_duration  FROM online_consultation WHERE uid = '". $current_user->ID ."'  AND payment_status='success' AND remaining_session > 0 AND therapy_name = '".$_GET['t']."'");
