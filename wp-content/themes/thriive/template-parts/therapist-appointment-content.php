...
if($therapyarr[0] == 'past'){
	$therapyname = $therapyarr[0].' '.$therapyarr[1].' '.$therapyarr[2];
	
}	
if($therapyarr[0] == 'eft'){
	$therapyname = 'Emotional Freedom Technique';
	
}
if($therapyarr[0] == 'inner'){
	$therapyname = 'Inner Child Healing';
	
}
if($therapyarr[0] == 'hypno'){
	$therapyname = 'Hypnotherapy';
    ...
    <div class="sex-therapy-therapist-card">
        <div class="sex-therapy-therapist-card-row sex-therapy-therapist-card-row1">
            <p class="sex-therapy-therapist-card-tname"><?php echo get_the_title(); ?></p>
             <p class="sex-therapy-therapist-card-therapy"><?php echo ucwords($therapyname);?> Therapist</p>
        </div>
        <div class="sex-therapy-therapist-card-row sex-therapy-therapist-card-row2">
            ...
            <div class="sex-therapy-therapist-card-about-therapist">
                ...
                <p class="sex-therapy-therapist-card-about-therapist-session-duration" style="margin-bottom:10px;">
				 ...
				 <p class="sex-therapy-therapist-card-about-therapist-session-duration"> <?php echo ' &#8377; '.$appointment_cost = get_field('appointment_cost',$post->ID).' Per Session';?></b></p>
                <?php 
        ...
        <div class="sex-therapy-therapist-card-row sex-therapy-therapist-card-row3">
            <button class="btnChatnow book_now_link_oc " id="book_now_<?php echo get_the_id(); ?>" data-slug="<?php echo $post->post_name; ?>" data-current_user="<?php echo base64_encode($current_user->ID);?>" data-from_status="<?php echo $from_status; ?>" data-therapy="<?php echo get_query_var("therapy")[0]; ?>" data-sessions="<?php echo $sessiondata->sessions_pending; ?>">Book Appointment</button>
        </div>
    </div>
</div>
<br>
<!--<aside itemscope itemtype="http://schema.org/Physician" itemprop="Physician">
  <figure>
    <div class="imgwrp">
      <?php $healer_image = get_the_post_thumbnail_url(get_the_ID());
       ?>
        <a href="<?php echo get_permalink(); ?>"><img src="<?php echo $healer_image; ?>" alt="<?php echo get_the_title(); ?>" title="<?php echo get_the_title(); ?>" itemprop="image"></a>
    </div>
