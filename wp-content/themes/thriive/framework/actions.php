<?php
	...
	add_action('wp_ajax_clevertap', 'clevertap');
	add_action('wp_ajax_nopriv_clevertap', 'clevertap');
	 
	add_action('wp_ajax_lastocid', 'lastocid');
	add_action('wp_ajax_nopriv_lastocid', 'lastocid'); 
	
	add_action('wp_ajax_liveresponse', 'liveresponse');
	add_action('wp_ajax_nopriv_liveresponse', 'liveresponse');
	
	add_action('wp_ajax_checkknowresponse', 'checkknowresponse');
	add_action('wp_ajax_nopriv_checkknowresponse', 'checkknowresponse');
	
	add_action('wp_ajax_whatsapp_payment_reminder', 'whatsapp_payment_reminder');
	add_action('wp_ajax_nopriv_whatsapp_payment_reminder', 'whatsapp_payment_reminder');
	 
	
	add_action('wp_ajax_TherapistCallInfo', 'TherapistCallInfo');
	add_action('wp_ajax_nopriv_TherapistCallInfo', 'TherapistCallInfo');
	...
	add_action('wp_ajax_changeavailability', 'changeavailability');
	add_action('wp_ajax_nopriv_changeavailability', 'changeavailability');
	...
	add_action('wp_ajax_therapist_details', 'therapist_details');
	add_action('wp_ajax_nopriv_therapist_details', 'therapist_details');
