...
function book_another_session(dialogue){
    ...
    if(dialogue == 'first'){
    $.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/chat_functions.php', {action:'fetch_link',therapist:to}, function(data){
        ////console.log(data);
...
function alert_support(mode){
  $.post('wp-content/themes/thriive/horoscope_new/chat-renew/Appointment/php/GET_CURR_USER.php', {action:'alert_support', ocid:OC_ID, mode:mode}, function(data){
    //console.log(data);
  });
}
