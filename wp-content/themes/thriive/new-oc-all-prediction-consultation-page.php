<?php /* Template Name: New All online consultation page */ 
...
<section class="banner">
        <img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2021/01/Soul-Listing-Page_Astrologer-Mobile.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2021/01/Soul-Listing-Page_Astrologer-Desktop.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
    </section>
	...
	<div class="banner-home">
		<div class="container">			
			<select id="select_therapy" class="form-control mb-2 mt-2">
				...
				<option value="<?php echo get_site_url()."/vastu-2"; ?>"<?php echo $current_url == 'vastu-2' ? 'selected': ''; ?>>vastu</option>
            </select>
			 <div class="row">
        ...
        while(have_rows('therapist_data', 'option')): the_row();
            if('all-page' == get_sub_field('custom_therapy')){
			...
			if($getPost) : ?>
				<section class="topreadingList">
                    ...
                    foreach($tempArr as $t){
                        ...
                        // }
                        setup_postdata( $post );
                        set_query_var('therapy',array('all-page'));
