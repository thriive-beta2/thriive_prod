		...
		<div class="row section col-12 mx-auto">
			...
			<form data-parsley-validate  class="form-element-section" action="" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input data-parsley-required="true" type="tel" data-parsley-required-message="Mobile is required." class="form-control international-number" id="mobile" name="mobile" value="<?php echo $current_user->mobile;?>" >
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="location" class="form-control" value="<?php echo $current_user->location;?>">
			  </div>
