...
<?php if(1==1){ if( is_page(74075) || is_page(78002) || is_page(77203) || is_page(59025) || is_page(79616)){
...
<?php
  ...
  ?>
<script src="<?php echo get_site_url();?>/wp-content/themes/thriive/horoscope_new/chat-renew/scripts/chat-script_test.js?v=20210819.75"></script>
...
include "/var/www/html/wp-content/themes/thriive/horoscope_new/instant_video/video-modals/video-modals.php";
    ...
    //print_r($previous_session);
      if($previous_session == '-1' || $previous_session == '-2'){
          ...
          echo '<script>document.querySelector("#session_data").innerText = "No Active Chat Sessions";</script>';
      } 
}
...
<script type="text/javascript">
  setInterval('check_for_data();', 15000);
</script>
