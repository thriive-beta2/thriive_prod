        ...
        <div class="" style="padding:0px 5px">
            <form data-parsley-validate id="oc_call_seeker_signup_btn" class="form-element-section w-100" action="" method="post"> 
				...
				<div class="form-group">
                    <input style="border-color: #ced4da !important;" data-parsley-required-message="Name is required." data-parsley-required="true" type="text" class="form-control" id="fname" name="fname" placeholder="Enter your Name*" autocomplete="off">
                </div>
				<!--<div class="form-group">
                    <input style="border-color: #ced4da !important;" data-parsley-required-message="Username is required." data-parsley-required="true" type="text" class="form-control" id="username" name="username" placeholder="Enter your username*" autocomplete="off">
                </div>-->
               <div class="form-group">
                ...
                <button type="submit" class="btnConsult" name="call_seeker_signup_btn" id="oc_call_seeker_signup_btn">Register</button>
            </form>
