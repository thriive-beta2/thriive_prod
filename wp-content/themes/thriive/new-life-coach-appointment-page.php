<?php /* Template Name: New Life Coach appointment page */ 
...
<div class="container">
	<div class="row">
		<h1 class="hpctitle">Life Coach</h1>
		...
		<div class="container">			
			...
			<div id="therapyres">	
				...
				$getPost = $wpdb->get_results( 
					"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (38354,29032,55467,48564,55496,40360,46561,39041,23398,15302)"
				);
				
				// Loop Start
				if($getPost) : ?>
					<h1 class="och1title">Premium Life Coach</h1>
